...
@section('title')Home | Tradional Bazar @endsection
@section('content')
			...
			<div class="row fill_height">
				...
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						<h1 class="banner_text">New era of Fashion</h1>
						<!-- <div class="banner_price"><span>PKR530</span>PKR460</div> -->
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							...
							<div class="char_subtitle">All over Malir</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							...
							<div class="char_subtitle">on 7 days of <br> purchase</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							...
							<!-- <div class="char_subtitle">from PKR50</div> -->
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Instant Promotions</div>
							<div class="char_subtitle">on occasions</div>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="owl-carousel owl-theme deals_slider">
								...
								<div class="owl-item deals_item">
									...
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
											...
											<div class="deals_item_price_a ml-auto">PKR300</div>
										</div>
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_name">Beoplay H7</div>
											<div class="deals_item_price ml-auto">PKR225</div>
										</div>
										<div class="available">
								...
								<div class="owl-item deals_item">
									...
									<div class="deals_content">
										...
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_name">Beoplay H7</div>
											<div class="deals_item_price ml-auto">PKR.225</div>
										</div>
										<div class="available">
											<div class="available_line d-flex flex-row justify-content-start">
												<div class="available_title">Available: <span>6</span></div>
										...
										<div class="featured_slider_item">
											...
											<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
												...
												<div class="product_content">
													<div class="product_price discount">PKR.{{$product->selling_price}}<span>PKR.300</span></div>
													<div class="product_name"><div><a href="{{route('product', $product->id)}}">{{$product->product_name}}</a></div></div>
								...
								<div class="featured_slider slider">
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/featured_1.png" alt=""></div>
											<div class="product_content">
												<div class="product_price discount">PKR.225<span>PKR.300</span></div>
									...
									<div class="featured_slider_item">
										...
										<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content">
												<div class="product_price">PKR.379</div>
									...
									<div class="featured_slider_item">
										...
										<div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content">
												<div class="product_price">PKR.225</div>
									...
									<div class="d-flex flex-column align-items-center justify-content-center">
										...
										<div class="arrivals_single_content">
											...
											<div class="arrivals_single_name_container clearfix">
												...
												<div class="arrivals_single_price text-right">PKR.379</div>
											</div>
								...
								<div class="bestsellers_item discount">
									<div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
										...
										<div class="bestsellers_content">
											...
											<div class="bestsellers_price discount">PKR.225<span>PKR.300</span></div>
										</div>
									</div>
						...
						<div class="owl-carousel owl-theme viewed_slider">
							...
							<div class="owl-item">
								<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_price">PKR.225<span>PKR.300</span></div>
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_price">PKR.379</div>
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_price">PKR.225</div>
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_price">PKR.375</div>
